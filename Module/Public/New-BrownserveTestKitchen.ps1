function New-BrownserveTestKitchen
{
    ...
    process
    {
        ...
        $ManifestDirectory = Join-Path $SpecPath 'manifests'
        $ManifestPath = Join-Path $ManifestDirectory $ManifestName
        $ManifestContent = "include $ModuleName"
        $TestHieraDirectory = Join-Path $SpecPath 'hiera'
        $TestHieraPath = Join-Path $TestHieraDirectory 'common.yaml'
        $KitchenYMLContent = "---`n# This file is generated by a tool, any notes will be lost.`n# For help see https://github.com/neillturner/kitchen-puppet/blob/master/provisioner_options.md"
        ...
        try
        {
            New-Item $KitchenYmlPath -Value $KitchenYMLContent -ErrorAction 'Stop'
        }
        catch
        {
        ...
        try
        {
            New-Item $ManifestDirectory -ItemType Directory -ErrorAction 'Stop'
            New-Item $ManifestPath -ItemType File -Value $ManifestContent -ErrorAction 'Stop'
        }
        catch
        {
        ...
        try
        {
            New-Item $TestHieraDirectory -ItemType Directory -ErrorAction 'Stop'
            New-Item $TestHieraPath -ItemType File -Value $TestHieraContent -ErrorAction 'Stop'
        }
        catch
        {
